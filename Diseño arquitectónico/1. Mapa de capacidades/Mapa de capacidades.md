...
## Mapa de Capacidades del Sistema Clipp Taxi 3.0
![Mapa de Capacidades]()
...
1. **Planificación**
2. **Gestión de flotas**
3. **Gestión del viaje y experiencia de usuario**
4. **Gestión de pago**
...
1. **Gestión de zonas de cobertura**  
   Permite definir las areas geograficas de operación, las zonas de cobertura, y las zonas de tarifario.
2. **Pragramación de recursos**   
